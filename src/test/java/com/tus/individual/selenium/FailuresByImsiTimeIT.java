...
class FailuresByImsiTimeIT {

    private WebDriver driver;
    private WebDriverWait wait;
    private String jwtToken;

    private static final String EMAIL = "test_customer_service@example.com";
    ...
    @Test
    void testFailuresByImsiTimeQuery() {
        navigateToFailuresByImsiTime();

        WebElement imsiField = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("imsi")));
        ...
        // ✅ Test IMSI and Date-Time values
        String testImsi = "123456789012345";
        String startTimeValue = "2020-01-01T00:00";
        String endTimeValue = "2020-12-12T00:00";

        // ✅ Enter IMSI and date-time values
        imsiField.clear();
        imsiField.sendKeys(testImsi);
        ...
        // ✅ Ensure JavaScript detects changes
        ...
        // ✅ Exit test successfully after button click
        return;
    }
    ...
    void navigateToFailuresByImsiTime() {
        WebElement sidebar = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("sidebar")));
        WebElement failuresByImsiTimeNav = wait.until(ExpectedConditions.elementToBeClickable(By.id("byimsitimeNav")));
        failuresByImsiTimeNav.click();
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("imsi")));
    }
}
